...
def parse_flight_data(file_src, name, df_aircrafts):
    ...
    if not os.path.exists(f'data/{name}_dict.pkl'):
        ...
        flights = Dict2Level()
        for index, count in tqdm(df_flights.items(), desc='Parsing flights for each airport'):
            flights.add(index[0], index[1], values={index[2]: count}, cnt=count)
...
query_arrivals(df_airports, df_aircrafts)
parse_flight_data("data_covid_19/flightlist_20200101_20200131.csv", "flights_jan", df_aircrafts)
parse_flight_data("data_covid_19/flightlist_20200201_20200229.csv", "flights_feb", df_aircrafts)
parse_flight_data("data_covid_19/flightlist_20200301_20200331.csv", "flights_mar", df_aircrafts)
parse_flight_data("data_covid_19/flightlist_20200401_20200430.csv", "flights_apr", df_aircrafts)
parse_flight_data("data_covid_19/flightlist_20200501_20200531.csv", "flights_may", df_aircrafts)
