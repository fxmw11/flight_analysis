...
def drop_irrelevant_data(df, irrelevant_manu):
    ...
    # drop manufacturers of small/light weight aircrafts
    manus = ['Agusta', 'Airbus Helicopters', 'Balloon', 'Bell', 'Ercoupe', 'Eurocopter', 'Flugzeugbau', 'Fuji',
             'Grob', 'Grumman', 'Honda', 'Hughes', 'Leonardo', 'mbb', 'MBB', 'Murphy', 'Murr', 'Remos', 'Robin',
            'Saab', 'Sikorsky', 'Swearingen', 'Tecna', 'Tupolev', 'Vulcanair']
    ...
    subquery = build_string_query('model', 'startswith', ['PT-', 'KC-', 'C-', 'E-', 'F-', 'FA-'], 'or')
...
def add_alternatives(df, manu_col, model_col):
    ...
    add_model_alt('C-17', 'Boeing')
    add_model_alt('C-40', 'Boeing')
